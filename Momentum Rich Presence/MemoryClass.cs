...
namespace Memory
{
    public class Mem
    {
        ...
        public bool readMemory(ref byte[] array, string code, string file = "")
        {
            ...
            bool flag2 = Mem.ReadProcessMemory(Mem.pHandle, lpBaseAddress, array, (UIntPtr)array.Length, IntPtr.Zero);
            return flag2;
        }

        public string readString(string code, string file = "", int size = 12)
        {
            byte[] array = new byte[size];
            bool flag2 = readMemory(ref array, code, file);
            string result;
            if (flag2)
            {
